...
OWNER_ID = int(getenv("OWNER_ID", "6449309718"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "krishsupport")
UPDATE_CHNL = getenv("UPDATE_CHNL", "krishnetwork")
OWNER_USERNAME = getenv("OWNER_USERNAME", "ily16k")
